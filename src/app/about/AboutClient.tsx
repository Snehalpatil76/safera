        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-16">
            <motion.div variants={fadeInUp} className="flex gap-5 items-start p-6 rounded-2xl border border-white/5 bg-white/[0.01] hover:bg-white/[0.03] transition-all duration-300">
              <div className="w-14 h-14 rounded-xl bg-primary-purple/10 flex items-center justify-center text-primary-purple mb-6 border border-primary-purple/15 shrink-0">
      ...
      <section className="py-24 md:py-36 bg-[#15151E]/20 border-b border-white/8 relative">
        ...
        >
          ...
          <motion.p variants={fadeInUp} className="text-gray-text text-base md:text-lg max-w-2xl mx-auto mb-10 leading-relaxed">
            Our current suite includes <strong className="text-white">Cohop</strong>, a verified community for collaborative and confident travel, and <strong className="text-white">Maira</strong>, a private space for guidance and peer-to-peer sharing.
          </motion.p>
